...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('plugins/bootstrap/css/sidebars.css')  }} "  >
...
<main>
  <h1 class="visually-hidden">Prueba Laravel</h1>

  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      
      <span class="fs-4">Prueba Laravel</span>
    </a>
    <hr>
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="{{ asset('img/guest.png')  }}" alt="" width="32" height="32" class="rounded-circle me-2">
        <strong>Anonymus user</strong>
      </a>
  ...
  <div class="container">
    ...
    <script src="{{ asset('plugins/bootstrap/js/sidebars.js')  }}"></script>
</body>
